...
//    }
  ...
  public void methodReturned(Spy spy, String methodCall, String returnMsg)
  {
    ...
    {
      String header = methodCall + " clase ";
      if (logger.isDebugEnabled() 
    		  && (methodCall.contains("select ")
    				  || methodCall.contains("SELECT ")
    				  || methodCall.contains("INSERT ")
    				  || methodCall.contains("insert ")
    				  || methodCall.contains("update ")
    				  || methodCall.contains("UPDATE ")
    				  || methodCall.contains("delete ")
    				  || methodCall.contains("DELETE ")
    				  || methodCall.contains("call ")
    				  || methodCall.contains("CALL "))
    		       && !methodCall.contains("nextval "))
      {
  ...
  private static String getDebugInfo()
  {
    ...
    if (stackTrace != null)
    {
      ...
      else
      {
        ...
        dump.append("(").
          append(stackTrace[j].getFileName().replace("Test", "")).append(")");
      }
