...
public class JuradoExternoUniversidadFacadeTest {
	...
	@EJB
	private JuradoExternoUniversidadFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		JuradoExternoUniversidad av = new JuradoExternoUniversidad();
		facade.create(av);
		av.setCargo("aa");
		facade.edit(av);
		facade.remove(av);
