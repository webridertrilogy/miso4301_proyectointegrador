...
import co.uniandes.sisinfo.serviciosfuncionales.ComandoAuditoriaFacadeLocal;
...
public class ComandoAuditoriaFacadeTest {
	...
	@EJB
	private ComandoAuditoriaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ComandoAuditoria av = new ComandoAuditoria();
		facade.create(av);
		av.setNombre("aa");
		facade.edit(av);
		facade.remove(av);
