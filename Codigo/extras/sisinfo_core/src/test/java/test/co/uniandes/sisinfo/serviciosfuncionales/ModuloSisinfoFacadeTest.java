...
public class ModuloSisinfoFacadeTest {
	...
	@EJB
	private ModuloSisinfoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ModuloSisinfo av = new ModuloSisinfo();
		
		facade.create(av);
		av.setDescripcionModulo("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.buscarModulosPublicos();
