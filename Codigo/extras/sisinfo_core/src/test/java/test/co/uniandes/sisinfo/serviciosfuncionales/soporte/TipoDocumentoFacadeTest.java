package test.co.uniandes.sisinfo.serviciosfuncionales.soporte;
...
public class TipoDocumentoFacadeTest {
	...
	@EJB
	private TipoDocumentoFacadeLocal facade;
	

	@Test
	public void testAll() throws SQLException {
		TipoDocumento av = new TipoDocumento();
		facade.create(av);
		av.setDescripcion("22");
		facade.edit(av);
		facade.remove(av);
