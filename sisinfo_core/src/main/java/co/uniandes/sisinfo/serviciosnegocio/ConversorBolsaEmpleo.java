 ...
 */
public class ConversorBolsaEmpleo {
    ...
    public ConversorBolsaEmpleo(ConstanteRemote constanteBean, EstudianteFacadeRemote estudianteFacade, PersonaFacadeRemote personaFacade,
        ...
        this.tipoAsistenciaGraduadaFacade = tipoAsistenciaGraduadaFacade;
        ...
        this.estudiantePostgradoFacade = estudiantePostgradoFacade;
        this.proponenteFacade = proponenteFacade;
        this.ofertaFacade = ofertaFacade;
        this.informacionEmpresaFacade = informacionEmpresaFacade;
    }
    ...
    */
    public Oferta crearOfertaDesdeSecuencia(Secuencia secOferta){
        ...
        if(correoContacto != null){
         ...
         Secuencia estado = secOferta.obtenerPrimeraSecuencia(constanteBean.getConstante(Constantes.TAG_PARAM_ESTADO_OFERTA));
        if(estado != null){
            oferta.setEstado(estado.getValor());
        }
    ...
    */
    public Proponente crearProponenteAPartirDePersona(String correo){
        ...
        proponente.setOfertas(new ArrayList<Oferta>());
    ...
    private TipoAsistenciaGraduada consultarTipo(Secuencia secTipo) {
        ...
        if(secNombreTipo != null){
            tipoAsistenciaGraduada = tipoAsistenciaGraduadaFacade.findByTipo(secNombreTipo.getValor());
        }
