 ...
 * @author JuanCamilo
 */
@MessageDriven(mappedName = "ColaCredencial", activationConfig = {
...
public class CredencialMessageBean implements MessageListener {
    ...
    public CredencialMessageBean() {
        try {
            ...
            Logger.getLogger(CredencialMessageBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        try {
            ...
            if (!redelivered) {
                if (replyDestination != null) {
                    ...
                    if (nombreComando.equals(getConstanteBean().getConstante(Constantes.CMD_CREAR_CREDENCIAL))) {
                        respuesta = Boolean.toString(credencialBean.crearCredencial(comandoXML));
                    }
