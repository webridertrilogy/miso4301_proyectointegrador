 ...
 * @author ale-osor
 */
@MessageDriven(mappedName = "ColaListaNegra", activationConfig =  {
...
public class ListaNegraMessageBean implements MessageListener {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            if(!redelivered)
            {
                ...
                if(nombreComando.equals(getConstanteBean().getConstante(Constantes.CMD_AGREGAR_A_LISTA_NEGRA)))
                {
                    respuesta = listaNegraBean.agregarAListaNegra(comandoXML);
                }
                else if(nombreComando.equals(getConstanteBean().getConstante(Constantes.CMD_ELIMINAR_DE_LISTA_NEGRA)))
                {
                    respuesta = listaNegraBean.eliminarDeListaNegra(comandoXML);
                }                
