 ...
 */
@Entity
@Table(name = "h_tesis1_rechazadas")
@NamedQueries({
    @NamedQuery(name = "h_tesis1_rechazadas.findByCorreoEstudiante", query = "SELECT e FROM h_tesis1_rechazadas e WHERE e.correoEstudiante = :correo"),
    @NamedQuery(name = "h_tesis1_rechazadas.findByCorreoasesor", query = "SELECT e FROM h_tesis1_rechazadas e WHERE e.correoAsesor = :correo")
})
public class h_tesis1_rechazadas implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof h_tesis1_rechazadas)) {
            return false;
        }
        h_tesis1_rechazadas other = (h_tesis1_rechazadas) object;
