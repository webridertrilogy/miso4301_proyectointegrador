 ...
 */
@Entity
@Table(name = "h_otras_actividades")
public class h_otras_actividades implements Serializable {
    ...
    public h_otras_actividades(Long id, String nombre, String descripcion, Double dedicacionSemanal) {
        this.id = id;
        this.nombre = nombre;
    ...
    public h_otras_actividades(String nombre, String descripcion, Double dedicacionSemanal) {
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.dedicacionSemanal = dedicacionSemanal;
    }

    public h_otras_actividades() {
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof h_otras_actividades)) {
            return false;
        }
        h_otras_actividades other = (h_otras_actividades) object;
