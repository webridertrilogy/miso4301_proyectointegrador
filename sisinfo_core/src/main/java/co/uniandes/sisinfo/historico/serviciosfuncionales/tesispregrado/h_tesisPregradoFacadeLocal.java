 ...
 */
@Local
public interface h_tesisPregradoFacadeLocal {
    ...
    List<h_tesisPregrado> findByEstadoYCorreoAsesor(String estado, String correo);

    List<h_tesisPregrado> findBySemestreYCorreoAsesor(String semestre, String correo);
}
