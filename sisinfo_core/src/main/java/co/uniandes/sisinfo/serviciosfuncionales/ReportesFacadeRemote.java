...
public interface ReportesFacadeRemote {
    ...
    String hacerReporteEstadoSolicitudesMonitoresCursosPorEstado(String estadoSolicitud);
    ...
    String hacerReporteDeVigenciaDeUsuarios(Long idLaboratorio);

    String hacerReporteUsoElementosLaboratorio(Long idLaboratorio);
