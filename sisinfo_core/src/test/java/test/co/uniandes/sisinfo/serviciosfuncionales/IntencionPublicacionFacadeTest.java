...
public class IntencionPublicacionFacadeTest {
	...
	@EJB
	private IntencionPublicacionFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		IntencionPublicacion av = new IntencionPublicacion();
		facade.create(av);
		av.setObservaciones("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
