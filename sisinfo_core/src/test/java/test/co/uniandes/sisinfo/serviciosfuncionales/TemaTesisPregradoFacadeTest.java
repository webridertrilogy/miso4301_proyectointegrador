...
public class TemaTesisPregradoFacadeTest {
	...
	@EJB
	private TemaTesisPregradoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		TemaTesisPregrado av = new TemaTesisPregrado();
		
		facade.create(av);
		av.setAreasInteres("a");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCorreoAsesor("a");
		facade.findByNombreYCorreoAsesorYPeriodo("1","1","1");
		facade.findByCorreoAsesor("1");
		facade.findByPeriodoYCorreoAsesor("1", "1");
	}
}