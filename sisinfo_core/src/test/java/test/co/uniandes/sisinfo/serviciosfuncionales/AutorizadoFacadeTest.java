...
import co.uniandes.sisinfo.serviciosfuncionales.AutorizadoFacadeLocal;
...
public class AutorizadoFacadeTest {
	...
	@EJB
	private AutorizadoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Autorizado av = new Autorizado();
		facade.create(av);
		av.setPuedeReservarATerceros(true);
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findAutorizadoByCorreo("a");
