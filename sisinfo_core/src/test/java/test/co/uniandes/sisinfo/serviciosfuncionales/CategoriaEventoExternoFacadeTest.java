...
public class CategoriaEventoExternoFacadeTest {
	...
	@EJB
	private CategoriaEventoExternoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		CategoriaEventoExterno av = new CategoriaEventoExterno();
		facade.create(av);
		av.setNombre("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);	
		facade.findByNombre("qq");
