...
public class ProponenteFacadeTest {
	...
	@EJB
	private ProponenteFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Proponente av = new Proponente();
		
		facade.create(av);
		av.setEsEmpresa(true);
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCorreo("a");
		facade.findByIdOferta(1l);
		facade.findByTipoEmpresa();
