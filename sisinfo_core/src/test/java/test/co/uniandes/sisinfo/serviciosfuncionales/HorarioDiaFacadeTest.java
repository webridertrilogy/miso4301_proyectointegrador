...
import co.uniandes.sisinfo.serviciosfuncionales.HorarioDiaFacadeLocal;
...
public class HorarioDiaFacadeTest {
	...
	@EJB
	private HorarioDiaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		HorarioDia av = new HorarioDia();
		facade.create(av);
		av.setHoraFin(5);
		facade.edit(av);
		facade.remove(av);
