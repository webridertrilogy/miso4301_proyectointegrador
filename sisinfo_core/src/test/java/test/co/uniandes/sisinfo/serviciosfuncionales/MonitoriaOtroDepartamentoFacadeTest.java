...
public class MonitoriaOtroDepartamentoFacadeTest {
	...
	@EJB
	private MonitoriaOtroDepartamentoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		MonitoriaOtroDepartamento av = new MonitoriaOtroDepartamento();
		
		facade.create(av);
		av.setNombreCurso("12");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCodigoEstudiante("123");
		facade.findByCodigoEstudianteAndCodigoCurso("123", "13");
