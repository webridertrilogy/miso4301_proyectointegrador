...
public class Horario_DisponibleFacadeTest {
	...
	@EJB
	private Horario_DisponibleFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Horario_Disponible av = new Horario_Disponible();
		facade.create(av);
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCodigoEstudiante("aa");
