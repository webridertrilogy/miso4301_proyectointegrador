...
import co.uniandes.sisinfo.serviciosfuncionales.RespuestaFacadeLocal;
...
public class RespuestaFacadeTest {
	...
	@EJB
	private RespuestaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Respuesta av = new Respuesta();
