...
public class Monitoria_SolicitadaFacadeTest {
	...
	@EJB
	private Monitoria_SolicitadaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Monitoria_Solicitada av = new Monitoria_Solicitada();
		
		facade.create(av);
		av.setNota_materia(1d);
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
