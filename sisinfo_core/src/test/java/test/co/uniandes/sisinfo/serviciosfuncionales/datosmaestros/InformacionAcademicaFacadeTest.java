...
public class InformacionAcademicaFacadeTest {
	...
	@EJB
	private InformacionAcademicaFacadeLocal facade;
	

	@Test
	public void testAll() throws SQLException {
		InformacionAcademica av = new InformacionAcademica();
		facade.create(av);
		av.setCreditosAprobados(4d);
		facade.edit(av);
		facade.remove(av);
		facade.find(1l);
		facade.findAll();
