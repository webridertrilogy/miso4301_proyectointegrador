...
public class VotacionFacadeTest {
	...
	@EJB
	private VotacionFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Votacion av = new Votacion();
		...
		facade.remove(av);
		facade.find(1L);
		facade.findVotacionesActivas();
		facade.findVotacionesPorCorreo("a");
		facade.findByCorreoYIDVotacion("1", "1");
		facade.findByIdVotacion("1");
	}
}