...
public class InformacionEmpresaFacadeTest {
	...
	@EJB
	private InformacionEmpresaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		InformacionEmpresa av = new InformacionEmpresa();
		facade.create(av);
		av.setNombreEmpresa("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
