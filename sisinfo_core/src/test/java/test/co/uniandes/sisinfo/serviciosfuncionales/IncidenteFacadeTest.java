...
public class IncidenteFacadeTest {
	...
	@EJB
	private IncidenteFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Incidente av = new Incidente();
		facade.create(av);
		av.setDescripcionSolucion("qq");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByPersonaSoporte(1L);
