...
public class LaboratorioFacadeTest {
	...
	@EJB
	private LaboratorioFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Laboratorio av = new Laboratorio();
		facade.create(av);
		av.setActivo(true);
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findLaboratoriosAutorizados("aa");
		facade.findLaboratoriosEncargado("1");
