...
public class MonitoriaFacadeTest {
	...
	@EJB
	private MonitoriaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		MonitoriaAceptada av = new MonitoriaAceptada();
		...
		facade.findByCRNYCorreo("123", "aa");
		facade.findBySolicitud(1L);
