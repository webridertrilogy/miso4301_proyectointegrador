...
import co.uniandes.sisinfo.serviciosfuncionales.ParametroAceptadoFacadeLocal;
...
public class ParametroAceptadoFacadeTest {
	...
	@EJB
	private ParametroAceptadoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ParametroAceptado av = new ParametroAceptado();
		
		facade.create(av);
		av.setNombreParametro("as");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByTipoTarea("1");
