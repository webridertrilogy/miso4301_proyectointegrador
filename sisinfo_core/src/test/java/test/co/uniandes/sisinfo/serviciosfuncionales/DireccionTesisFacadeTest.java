...
public class DireccionTesisFacadeTest {
	...
	@EJB
	private DireccionTesisFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		DireccionTesis av = new DireccionTesis();
		facade.create(av);
		av.setObservaciones("a");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findDireccionTesisByName("a");
