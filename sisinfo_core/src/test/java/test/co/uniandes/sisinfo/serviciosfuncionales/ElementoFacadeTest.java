...
import co.uniandes.sisinfo.serviciosfuncionales.ElementoFacadeLocal;
...
public class ElementoFacadeTest {
	...
	@EJB
	private ElementoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Elemento av = new Elemento();
		facade.create(av);
