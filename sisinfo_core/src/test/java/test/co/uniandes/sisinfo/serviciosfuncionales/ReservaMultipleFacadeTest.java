...
public class ReservaMultipleFacadeTest {
	...
	@EJB
	private ReservaMultipleFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ReservaMultiple av = new ReservaMultiple();
		
		facade.create(av);
		av.setPeriodicidad("1");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.consultarReservasMultiplesPorPeriodicidad("1");
		facade.consultarReservasMultiplesPorFinalizacionReservaMultiple(new Date());
		facade.consultarReservasMultiplesPorReserva(1l);
