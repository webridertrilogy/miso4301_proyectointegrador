...
public class InscripcionSubareaInvestigacionFacadeTest {
	...
	@EJB
	private InscripcionSubareaInvestigacionFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		InscripcionSubareaInvestigacion av = new InscripcionSubareaInvestigacion();
		facade.create(av);
		av.setAprobadoAsesor("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCorreoCoordinador("aa");
		facade.findByCorreoAsesor("aa");
		//facade.findByEstadoInscripcion("aa");
		facade.findByCorreoEstudiante("aa");
		facade.findByPeriodoTesis1("1");
		facade.findByCoordinadoresSubAreaConEstado("aa");
		facade.findByAsesoresSubAreaConEstado("aa");
