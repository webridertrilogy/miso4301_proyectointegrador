...
public class ReservaInventarioFacadeTest {
	...
	@EJB
	private ReservaInventarioFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ReservaInventario av = new ReservaInventario();
		...
		facade.remove(av);
		facade.find(1L);
		facade.consultarReservasPorNombreLaboratorio("aa");
		facade.consultarReservasPorNombreLaboratorioyEstado("aa", "a");
		facade.consultarReservasByPersonaYEstado("aa", "a");
		facade.consultarReservasAnterioresAFechaByEstado(new Date(), "a");
		//facade.consultarReservasPorEstado("a");
