...
public class InscripcionAsistenteFacadeTest {
	...
	@EJB
	private InscripcionAsistenteFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		InscripcionAsistente av = new InscripcionAsistente();
		facade.create(av);
		av.setInscrito("i");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByHash("aa");
		facade.darInscripcionesAsistentePorCorreo("a");
		facade.findByIdInscripcionYCorreoPersona("a", 1L);
