...
public class InscripcionEventoExternoFacadeTest {
	...
	@EJB
	private InscripcionEventoExternoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		InscripcionEventoExterno av = new InscripcionEventoExterno();
		facade.create(av);
		
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findInscripcionesByIdContacto(1L);
