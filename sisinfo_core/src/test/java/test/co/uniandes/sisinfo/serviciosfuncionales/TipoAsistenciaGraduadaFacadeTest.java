...
public class TipoAsistenciaGraduadaFacadeTest {
	...
	@EJB
	private TipoAsistenciaGraduadaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		TipoAsistenciaGraduada av = new TipoAsistenciaGraduada();
		
		facade.create(av);
		av.setInfoRequerida("a");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
