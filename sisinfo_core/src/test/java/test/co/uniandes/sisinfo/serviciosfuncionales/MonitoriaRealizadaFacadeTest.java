...
public class MonitoriaRealizadaFacadeTest {
	...
	@EJB
	private MonitoriaRealizadaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		MonitoriaRealizada av = new MonitoriaRealizada();
		
		facade.create(av);
		av.setCodigoCurso("123");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
