...
public class ListaBlancaErroresSisinfoFacadeTest {
	...
	@EJB
	private ListaBlancaErroresSisinfoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		ListaBlancaErroresSisinfo av = new ListaBlancaErroresSisinfo();
		
		facade.create(av);
		av.setExplicacion("qq");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
