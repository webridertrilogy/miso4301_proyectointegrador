...
public class Tesis2FacadeTest {
	...
	@EJB
	private Tesis2FacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Tesis2 av = new Tesis2();
		...
		facade.findByEstadoTesis("1");
		facade.findByPeriodo("a");
		facade.findByHorarioSustentacion("1");
		facade.findAllOrderBySemestre();
		facade.findBySincomentariosTesis("1");
		facade.findAsesoresByEstadoYPeriodo("1", "1");
		//facade.findByEstadoYPeriodoTesis("1", "1");
		facade.findDetallesSustentacionByPeriodoEstado("1");
		facade.findByDiferentePeriodoTesis("1", "a");
	}
}