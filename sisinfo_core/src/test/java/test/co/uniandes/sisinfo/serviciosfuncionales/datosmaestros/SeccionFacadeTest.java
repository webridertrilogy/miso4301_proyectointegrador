...
public class SeccionFacadeTest {
	...
	@EJB
	private SeccionFacadeLocal facade;
	

	@Test
	public void testAll() throws SQLException {
		Seccion av = new Seccion();
		av.setCrn("123");
		facade.create(av);
		av.setCrn("12");
		facade.edit(av);
		...
		facade.findByCRN("1");
		facade.hayVacantes("1");
		facade.contarSecciones();
		facade.contarSeccionesConMonitoresCompletos();
		facade.contarSeccionesRequierenMonitores();
		facade.contarSeccionesSinMonitores();
		facade.findByCorreoProfesor("123");
		facade.removeAll();
