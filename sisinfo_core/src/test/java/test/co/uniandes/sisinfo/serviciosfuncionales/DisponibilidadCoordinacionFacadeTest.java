...
public class DisponibilidadCoordinacionFacadeTest {
	...
	@EJB
	private DisponibilidadCoordinacionFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		DisponibilidadCoordinacion av = new DisponibilidadCoordinacion();
		facade.create(av);
