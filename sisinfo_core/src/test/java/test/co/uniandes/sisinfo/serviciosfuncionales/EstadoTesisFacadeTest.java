...
import co.uniandes.sisinfo.serviciosfuncionales.EstadoTesisFacadeLocal;
...
public class EstadoTesisFacadeTest {
	...
	@EJB
	private EstadoTesisFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		EstadoTesis av = new EstadoTesis();
		facade.create(av);
		av.setEstado("a");
		facade.edit(av);
		facade.remove(av);
