...
public class SolicitudMaterialBibliograficoFacadeTest {
	...
	@EJB
	private SolicitudMaterialBibliograficoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		SolicitudMaterialBibliografico av = new SolicitudMaterialBibliografico();
		...
		//facade.remove(av);
		facade.find(1L);
		//facade.findPrecioPromedioByRangoFecha(new Date(1),new Date(1));
		//facade.findPrecioTotalByRangoFecha(new Date(1), new Date(1));
		facade.findyBySolicitante("a");
		facade.findyByEstado("a");
		facade.findByRangoFecha(new Date(1), new Date(1));
		facade.findByAnioPublicacion(1987);
		facade.findyByProveedor("a");
		facade.findByRangoPrecio(1d, 2d);
	}
}