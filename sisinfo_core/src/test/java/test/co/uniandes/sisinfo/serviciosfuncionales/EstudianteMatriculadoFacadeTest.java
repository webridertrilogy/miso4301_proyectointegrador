...
public class EstudianteMatriculadoFacadeTest {
	...
	@EJB
	private EstudianteMatriculadoFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		EstudianteMatriculado av = new EstudianteMatriculado();
		facade.create(av);
		av.setApellidos("aa");
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
		facade.findByCarnet("a");
