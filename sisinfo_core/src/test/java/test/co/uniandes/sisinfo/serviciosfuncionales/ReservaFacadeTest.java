...
public class ReservaFacadeTest {
	...
	@EJB
	private ReservaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Reserva av = new Reserva();
		...
		facade.remove(av);
		facade.find(1L);
		facade.buscarReservasPorLogin("aa");
		facade.buscarReservasActualesPorLogin("aa");
		facade.buscarReservasPorCorreoYEstado("aa", "aa");
