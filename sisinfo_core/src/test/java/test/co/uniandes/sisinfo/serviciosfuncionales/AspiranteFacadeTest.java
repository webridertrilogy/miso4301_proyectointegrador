...
public class AspiranteFacadeTest {
	...
	@EJB
	private AspiranteFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		Aspirante av = new Aspirante();
		facade.create(av);
		av.getEstudiante();
		av.getHorario_disponible();
		av.getMonitoriasOtrosDepartamentos();
		av.getMonitoriasRealizadas();
		//av.getPersona();
		facade.edit(av);
		facade.remove(av);
		facade.find(1L);
