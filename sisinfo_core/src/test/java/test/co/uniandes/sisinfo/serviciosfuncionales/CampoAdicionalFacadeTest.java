...
import co.uniandes.sisinfo.serviciosfuncionales.CampoAdicionalFacadeLocal;
...
public class CampoAdicionalFacadeTest {
	...
	@EJB
	private CampoAdicionalFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		CampoAdicional av = new CampoAdicional();
		facade.create(av);
		av.setNombre("aa");
		facade.edit(av);
		facade.remove(av);
