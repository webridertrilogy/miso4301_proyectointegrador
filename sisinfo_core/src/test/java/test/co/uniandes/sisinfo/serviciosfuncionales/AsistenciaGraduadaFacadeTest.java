...
public class AsistenciaGraduadaFacadeTest {
	...
	@EJB
	private AsistenciaGraduadaFacadeLocal facade;
	
	@Test
	public void testAll() throws SQLException {
		AsistenciaGraduada av = new AsistenciaGraduada();
		facade.create(av);
		av.getPeriodo();
		av.getEncargado();
		av.getEstudiante();
		...
		facade.remove(av);
		facade.find(1L);
		facade.findByPeriodo("s");
		facade.findByCorreoEstudiante("a");
		facade.findByCorreoProfesor("d");
		facade.findByPeriodoYCorreoEstudiante("dd", "g");
